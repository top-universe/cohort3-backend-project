...
// Course-routes
courseRouter.post('/courses',userAuthenticate, 
// authRole('instructor'),
courseValidator.createCourseValidator, courseController.createCourse); // Create a new course
...
courseRouter.post('/courses/:courseId/lessons/:lessonId',userAuthenticate, authRole('instructor'), lessonController.uploadLesson);
